								...
								for(Component panelComponentOne: panelComponentsOne) {
									if(panelComponentOne instanceof JPanel) {
										...
										for(Component panelComponentTwo: panelComponentsTwo) {
											if(panelComponentTwo instanceof JButton && ((JButton) panelComponentTwo).getText().equalsIgnoreCase("Login")) {
												bot.mouseMove(login.getX() + panelComponentTwo.getX(), login.getY() + panelComponentTwo.getY());
											}
										}
									}
								}
